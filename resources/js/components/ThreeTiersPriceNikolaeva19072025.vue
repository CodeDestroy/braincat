<template>
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">19 июля 2025 года (суббота)</p>
  ...
  const tiers = [
    {
      name: 'Базовый',
      id: 'tier-base',
      href: '/payment/tier-base15/22',
      price: { 100: '2500' },
      description: 'Вебинар',
      features: [
        'врачи',
        'педагоги',
        'специалисты помогающих профессий и все заинтересованные лица'
      ],
      featured: false,
      cta: 'Оплатить',
    },
    {
      name: 'Льготный',
      id: 'tier-privilege',
      href: '/payment/tier-students15/22',
      price: { 100: '2000' },
      description: 'Вебинар',
      features: [
    ...
    },
    {
      name: 'Организации',
      id: 'tier-enterprise',
      href: '/payment/tier-enterprise15/22',
      price: 'По запросу',
      description: 'Вебинар',
      features: [
        'сотрудники организации (не менее 5 человек), участие в вебинаре которых оплачивает юридическое лицо по счету',
      ],
      featured: true,
      cta: 'Узнать',
    },
