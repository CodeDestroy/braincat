<template>
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-4xl text-center">
          <p class="mt-2 text-4xl font-bold tracking-tight text-mona-lisa-600 sm:text-5xl">Стоимость видеозаписи вебинара</p>
        </div>
        <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">24 апреля 2025 года (четверг)</p>
  ...
  const tiers = [
    ...
    },
    {
      name: 'Льготный',
      id: 'tier-privilege',
      href: '/payment/tier-students10/13',
      price: { 100: '500' },
      description: 'Видеозапись вебинара',
      features: [
    ...
    },
    {
      name: 'Организации',
      id: 'tier-enterprise',
      href: '/payment/tier-enterprise10/13',
      price: 'По запросу',
      description: 'Вебинар',
      features: [
        'владельцы медицинских организаций',
