<template>
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">17 мая 2025 года (суббота)</p>
  ...
  const tiers = [
    ...
    },
    {
      name: 'Льготный',
      id: 'tier-privilege',
      href: '/payment/tier-students11/16',
      price: { 100: '2000' },
      description: 'Видеозапись лекционно-практического вебинара',
      features: [
