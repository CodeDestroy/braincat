        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          ...
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <p>Общий практический стаж 26 лет в должности клинического психолога, нейропсихолога, патопсихолога, из них 15 лет работы патопсихологом медико-социальной экспертизы.</p>
