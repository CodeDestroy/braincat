<template>
    <section class="isolate overflow-hidden bg-white px-6 lg:px-8">
      <div class="relative mx-auto max-w-2xl py-24 sm:py-36 lg:max-w-4xl">
        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div class="col-span-2 w-64 lg:col-end-1 lg:row-span-2 lg:w-72">
            <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="img/bogutenko_list.jpg" alt="" />
          </div>
          <figcaption class="text-base lg:col-start-1 lg:row-start-1">
            <div class="text-lg font-semibold text-mona-lisa-600 sm:text-2xl">Богутенко Анна Фёдоровна</div>
            <div class="mt-1 text-gray-500">нейропсихолог, нутрициолог</div>
          </figcaption>
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <p>26 лет практической работы в должности клинического психолога, патопсихолога медико-социальной экспертизы, нейропсихолога. Нутрициолог, специалист в области нутриметаболомики и коррекции микробиоты</p>
            </blockquote>
          </div>
        </figure>
      </div>
