      ...
      <div class="relative mx-auto max-w-2xl py-24 sm:py-16 lg:max-w-4xl">
        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div class="col-span-2 w-64 lg:col-end-1 lg:row-span-2 lg:w-72">
            <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="img/lisavenko_list.jpg" alt="" />
          </div>
          <figcaption class="text-base lg:col-start-1 lg:row-start-1">
            <div class="text-lg font-semibold text-mona-lisa-600 sm:text-2xl">Марина Евгеньевна Лисавенко</div>
            <div class="mt-1 text-gray-500">педагог, психолог</div>
          </figcaption>
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <p>12 лет практической работы с детьми. Эксперт Школы приемных родителей. Создатель проекта "Я приемный родитель". Ведущая ресурсных тренингов для приемных матерей. Основатель и руководитель семейного клуба "Поговорим" для состоявшихся и будущих приемных родителей. Мама троих приемных детей.</p>
              <p class="font-semibold py-4">Сфера профессиональных интересов:</p>
              <ul class="marker:text-mona-lisa-600 list-disc ps-4">
                <li>когнитивно-поведенческий подход</li>
                <li>сказкотерапия</li>
                <li>МАК-карты</li>
