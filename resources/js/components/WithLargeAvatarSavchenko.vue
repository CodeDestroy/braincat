        ...
        <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          ...
          <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote class="text-gray-900">
              <p>Доктор с большим и многообразным опытом профилактики и лечения заболеваний ЛОР-органов у детей. Специалист по работе с приобретенными и врожденными патологиями, приводящими к снижению слуга у детей и взрослых.</p>
            </blockquote>
          </div>
        </figure>
      </div>
