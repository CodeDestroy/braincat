          ...
          <div class="mx-auto max-w-2xl lg:mx-0">
              <div class="hidden sm:mt-32 sm:flex lg:mt-16">
                  <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      Вебинар <strong class="text-mona-lisa-600">для родителей</strong> 
                  </div>
              </div>
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Интегративный подход в нейропсихологии. Понятие и значимость</h1>
              <p class="mt-6 text-lg leading-6 text-gray-600">нейропсихолог, нутрициолог Анна Федоровна Богутенко</p>
              <div class="mt-10 flex items-center gap-x-6">
                  <a href="#simple" class="rounded-md bg-mona-lisa-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-mona-lisa-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-mona-lisa-800">Просмотреть запись</a>
                  <a href="#with-large-avatar" class="text-sm font-semibold leading-6 text-gray-900">Узнать больше...</a>
              </div>
          </div>
        </div>
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_bogutenko_22052025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-1 text-lg leading-8 text-gray-600">22 мая 2025 года с 18-00 до 19-30</p>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Созревание, функционирование и пластичность центральной нервной системы напрямую связаны с общим соматическим состоянием, поступлением нутриентных компонентов, витаминно-минеральным статусом, наличием или отсутствием гипоксии и другими факторами.
                        </p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Заинтересованные родители, педагоги, дефектологи, психологи, специалисты помогающих профессий, студенты профильных ВУЗов и все, кто неравнодушен к детскому здоровью.
</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">На вебинаре мы разберем основные факторы, оказывающие влияние на развитие и функционирование головного мозга. Познакомимся с особенностями работы нейропсихолога в интегративном подходе с использованием биомедицинского направления.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="simple">
    <simple-bogutenko-22052025/>
</div>

<div id="with-large-avatar">
    <with-large-avatar-bogutenko/>
</div>
