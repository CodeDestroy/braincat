    ...
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div class="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div class="mx-auto max-w-2xl lg:mx-0">
              ...
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Решение детско-родительских конфликтов в арт-терапии</h1>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_kudryashova_15052025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-1 text-lg leading-8 text-gray-600"><strong>15 мая 2025 года (четверг)</strong></p>
            <p class="mt-0 text-lg leading-8 text-gray-600"><strong>3 академических часа:</strong> с 19-00 до 21-15</p>
        </div>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Детско-родительские конфликты особо актуальны в семейной психотерапии и психологическом консультировании. Запросы, связанные с данным видом конфликтов, а также детскими травмами, являются одними из самых распространенных в психолого-педагогической практике. </p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Психологи, педагоги, студенты профильных ВУЗов, родители, все кого интересуют подобные проблемы в детско-родительских отношениях.</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">С помощью арт-терапии мы выработаем стратегии поведения и расширения личного опыта в разрешении конфликтов между родителями и детьми. Все участники мероприятия получат именные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-kudryashova-15052025/>
</div>
