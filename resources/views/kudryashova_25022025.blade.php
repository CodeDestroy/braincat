...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-mona-lisa-700 sm:text-4xl">Арт-терапия в работе с детьми в норме и при ОВЗ: направления, преимущества, специфика используемых методик</h2>
        ...
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                ...
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Участники вебинара познакомятся с современными направлениями в арт-терапии, раскроют ключевые механизмы стратегий арт-терапевтических практик и их ресурсы, приобретут практический опыт использования арт-технологий. 
                        Именные сертификаты предоставляются только онлайн участникам вебинара, либо тем, кто произвел полную оплату мероприятия, но не смог на нем присутствовать.  В случае приобретения записи вебинара после его проведения ( с дисконтом)  - сертификаты не предоставляются!</p>
                  </dd>
                </div>
            </dl>
        </div>
