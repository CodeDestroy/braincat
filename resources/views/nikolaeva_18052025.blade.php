    ...
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div class="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div class="mx-auto max-w-2xl lg:mx-0">
              ...
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Что нужно знать о леворукости</h1>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_nikolaeva_18052025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-1 text-lg leading-8 text-gray-600"><strong>18 мая 2025 года (воскресенье)</strong></p>
            <p class="mt-0 text-lg leading-8 text-gray-600"><strong>4 академических часа:</strong> с 10-00 до 13-00</p>
        </div>
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                ...
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Воспитатели детских садов, педагоги, особенно начальных классов, родители и бабушки, которые в заботе о внуках пытаются их переучивать, психологи, дефектологи, педиатры, врачи общей практики, специалисты, работающие с детьми.</p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">На вебинаре мы научимся определять рукость, профиль функциональной сенсомоторной асимметрии, кросслатеральность. Узнаем как помогать детям с проблемами чтения,  как определять проблемы развития детей разных возрастов. Все участники мероприятия получат именные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-nikolaeva-20052025/>
</div>
