...
<div class="relative bg-white" {{-- style="height: 100vh;" --}} >
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl lg:mx-0">
              <div class="hidden sm:mt-32 sm:flex lg:mt-16">
                  <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      Вебинар <strong class="text-mona-lisa-600">для всех</strong> 
                  </div>
              </div>
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Раненый целитель</h1>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_nikolaeva_19072025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-1 text-lg leading-8 text-gray-600"><strong>19 июля 2025 года (суббота)</strong></p>
            <p class="mt-0 text-lg leading-8 text-gray-600"><strong>2,5 академических часа:</strong> с 11-00 до 13-00</p>
        </div>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto"> Вебинар посвящен анализу поведения любого человека, помогающего другим: врача, психолога, психотерапевта, учителя или родителя. Будет описана ситуация, в которой желание помочь превращается в желание управлять. В большей мере этот парадокс соответствует взаимодействию врача и пациента, когда больной пытается избежать ответственности за лечение своего состояния, а врач ошибочно берет на себя весь груз ответственности.</p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                ...
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">На вебинаре мы разберемся в механизмах злокачественного и благотворного влияния "целителей". Рассмотрим варианты поведения специалистов помогающих профессий. Найдем выходы из тупиковых ситуаций.  Все участники мероприятия получат именные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-nikolaeva-19072025/>
</div>
