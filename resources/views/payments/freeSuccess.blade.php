...
<div class="bg-gray-100 flex items-center justify-center" style="height: 70vh">
    <div class="bg-white shadow-md rounded-lg p-8 max-w-md text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-4">Вы успешно записались на курс!</h1>
        <p class="text-gray-600 mb-6">Спасибо за регистрацию. Ваша заявка была успешно обработана. В случае вопросов, пожалуйста, свяжитесь с нашей службой поддержки.</p>
