    ...
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div class="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div class="mx-auto max-w-2xl lg:mx-0">
              ...
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Аденоиды. Просто о сложном</h1>
              <p class="mt-6 text-lg leading-6 text-gray-600">детский ЛОР-врач, сурдолог Савченко Евгения Александровна</p>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_savchenko_21052025.jpg') }}" alt="">
        </div>
    </div>
</div>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Заболевания аденоидов у детей являются одной из важнейших проблем: с ними связано множество заблуждений, ведущих к неверной оценке состояния ребенка, ошибкам в диагностике и лечении.</p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                ...
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Мероприятие направлено на повышение грамотности в вопросах диагностики, лечения и профилактики заболеваний аденоиодов у детей. Все участники мероприятия получат именные сертификаты.</p>
                  </dd>
                </div>
            </dl>
        </div>
...
<div id="price-webinar">
    <three-tiers-price-savchenko-21052025/>
</div>

<div id="with-large-avatar">
    <with-large-avatar-savchenko/>
</div>

<div id="content">
    <content-savchenko-21052025/>
</div>
