    ...
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div class="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div class="mx-auto max-w-2xl lg:mx-0">
              ...
              <h1 class="mt-24 text-3xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">Интеллектуальные диагностические тесты Векслера для детей: WISC, WРРSI</h1>
        ...
        <div class="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img class="aspect-[3/2] w-full bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full" src="{{ asset('img/hero_tretyakova_17052025.jpg') }}" alt="">
        </div>
    </div>
</div>
...
<div class="bg-stone-100 py-24 sm:py-32"  id='dopobr'{{-- style="height: 100vh;" --}}>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-mona-lisa-700 sm:text-4xl">Видеозапись лекционно-практического вебинара </h2>
            <p class="mt-1 text-lg leading-8 text-gray-600">17 мая 2025 года с 10-00 до 13-00</p>
            <p class="mt-0 text-lg leading-8 text-gray-600"><strong>4 академических часа</strong></p>
            <p class="mt-0 text-lg leading-8 text-gray-600">лекция, диагностический практикум, обсуждение случая, ответы на вопросы</p>
        </div>
            ...
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                    ...
                    <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        <p class="flex-auto">Вебинар посвящен методике и практике использования детского (WISC) и дошкольного (WРРSI) вариантов диагностического теста Векслера.
                        </p>
                    </dd>
                </div>
                <div class="flex flex-col">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">Психологи, психиатры, дефектологи, логопеды, врачи общего профиля, педиатры, студенты профильных ВУЗов очной формы обучения, заинтересованные родители. </p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                      <p class="flex-auto">В результате обучения участники смогут определять уровень интеллектуального развития ребенка в норме и патологии, выявлять и прогнозировать сложности дошкольного и школьного обучения, составлять диагностические заключения и психологические рекомендации. Все участники мероприятия получат именные сертификаты. 
                       </p>
                  </dd>
                </div>
            </dl>
...
<div id="price-webinar">
    <three-tiers-price-tretyakova-17052025/>
</div>
